jQuery("#simulation")
  .on("click", ".s-6103c78c-07c8-42c0-a21c-62e0cbe41112 .click", function(event, data) {
  ...
  .on("mouseenter dragenter", ".s-6103c78c-07c8-42c0-a21c-62e0cbe41112 .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-6103c78c-07c8-42c0-a21c-62e0cbe41112 #s-Label_2": {
                      "attributes": {
                        "font-size": "13.0pt",
                    ...
                    "#s-6103c78c-07c8-42c0-a21c-62e0cbe41112 #s-Label_2 .valign": {
                      "attributes": {
                    ...
                    "#s-6103c78c-07c8-42c0-a21c-62e0cbe41112 #s-Label_2 span": {
                      "attributes": {
                        "color": "#6E7270",
                        "text-align": "center",
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-6103c78c-07c8-42c0-a21c-62e0cbe41112 #s-Label_3": {
                      "attributes": {
                        "font-size": "13.0pt",
                        "font-family": "Arial,Arial"
                      }
                    ...
                    "#s-6103c78c-07c8-42c0-a21c-62e0cbe41112 #s-Label_3 .valign": {
                      "attributes": {
                        "vertical-align": "middle",
                        "text-align": "center"
                      }
                    ...
                    "#s-6103c78c-07c8-42c0-a21c-62e0cbe41112 #s-Label_3 span": {
                      "attributes": {
                        "color": "#6E7270",
                        "text-align": "center",
                        "text-decoration": "none",
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-6103c78c-07c8-42c0-a21c-62e0cbe41112 #s-Label_4": {
                      "attributes": {
                        "font-size": "13.0pt",
                        "font-family": "Arial,Arial"
                      }
                    ...
                    "#s-6103c78c-07c8-42c0-a21c-62e0cbe41112 #s-Label_4 .valign": {
                      "attributes": {
                        "vertical-align": "middle",
                        "text-align": "center"
                      }
                    ...
                    "#s-6103c78c-07c8-42c0-a21c-62e0cbe41112 #s-Label_4 span": {
                      "attributes": {
                        "color": "#6E7270",
                        "text-align": "center",
                        "text-decoration": "none",
  ...
  .on("mouseleave dragleave", ".s-6103c78c-07c8-42c0-a21c-62e0cbe41112 .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getDirectEventFirer(this);
  ...
  .on("windowresize", ".s-6103c78c-07c8-42c0-a21c-62e0cbe41112 .windowresize", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-6103c78c-07c8-42c0-a21c-62e0cbe41112")) {
      cases = [
        {
          "blocks": [
            {
