jQuery("#simulation")
  .on("click", ".s-b0c8d07f-7004-4583-9896-81a3dce78928 .click", function(event, data) {
  ...
  .on("mouseenter dragenter", ".s-b0c8d07f-7004-4583-9896-81a3dce78928 .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-b0c8d07f-7004-4583-9896-81a3dce78928 #s-Label_2": {
                      "attributes": {
                        "font-size": "13.0pt",
                    ...
                    "#s-b0c8d07f-7004-4583-9896-81a3dce78928 #s-Label_2 .valign": {
                      "attributes": {
                    ...
                    "#s-b0c8d07f-7004-4583-9896-81a3dce78928 #s-Label_2 span": {
                      "attributes": {
                        "color": "#6E7270",
                        "text-align": "center",
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-b0c8d07f-7004-4583-9896-81a3dce78928 #s-Label_3": {
                      "attributes": {
                        "font-size": "13.0pt",
                        "font-family": "Arial,Arial"
                      }
                    ...
                    "#s-b0c8d07f-7004-4583-9896-81a3dce78928 #s-Label_3 .valign": {
                      "attributes": {
                        "vertical-align": "middle",
                        "text-align": "center"
                      }
                    ...
                    "#s-b0c8d07f-7004-4583-9896-81a3dce78928 #s-Label_3 span": {
                      "attributes": {
                        "color": "#6E7270",
                        "text-align": "center",
                        "text-decoration": "none",
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-b0c8d07f-7004-4583-9896-81a3dce78928 #s-Label_4": {
                      "attributes": {
                        "font-size": "13.0pt",
                        "font-family": "Arial,Arial"
                      }
                    ...
                    "#s-b0c8d07f-7004-4583-9896-81a3dce78928 #s-Label_4 .valign": {
                      "attributes": {
                        "vertical-align": "middle",
                        "text-align": "center"
                      }
                    ...
                    "#s-b0c8d07f-7004-4583-9896-81a3dce78928 #s-Label_4 span": {
                      "attributes": {
                        "color": "#6E7270",
                        "text-align": "center",
                        "text-decoration": "none",
  ...
  .on("mouseleave dragleave", ".s-b0c8d07f-7004-4583-9896-81a3dce78928 .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getDirectEventFirer(this);
  ...
  .on("windowresize", ".s-b0c8d07f-7004-4583-9896-81a3dce78928 .windowresize", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-b0c8d07f-7004-4583-9896-81a3dce78928")) {
      cases = [
        {
          "blocks": [
            {
