jQuery("#simulation")
  .on("click", ".s-0f48dc8b-de1b-47d3-9fce-7e4484aac5ec .click", function(event, data) {
  ...
  .on("mouseenter dragenter", ".s-0f48dc8b-de1b-47d3-9fce-7e4484aac5ec .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-0f48dc8b-de1b-47d3-9fce-7e4484aac5ec #s-Label_2": {
                      "attributes": {
                        "font-size": "13.0pt",
                    ...
                    "#s-0f48dc8b-de1b-47d3-9fce-7e4484aac5ec #s-Label_2 .valign": {
                      "attributes": {
                    ...
                    "#s-0f48dc8b-de1b-47d3-9fce-7e4484aac5ec #s-Label_2 span": {
                      "attributes": {
                        "color": "#6E7270",
                        "text-align": "center",
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-0f48dc8b-de1b-47d3-9fce-7e4484aac5ec #s-Label_3": {
                      "attributes": {
                        "font-size": "13.0pt",
                        "font-family": "Arial,Arial"
                      }
                    ...
                    "#s-0f48dc8b-de1b-47d3-9fce-7e4484aac5ec #s-Label_3 .valign": {
                      "attributes": {
                        "vertical-align": "middle",
                        "text-align": "center"
                      }
                    ...
                    "#s-0f48dc8b-de1b-47d3-9fce-7e4484aac5ec #s-Label_3 span": {
                      "attributes": {
                        "color": "#6E7270",
                        "text-align": "center",
                        "text-decoration": "none",
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-0f48dc8b-de1b-47d3-9fce-7e4484aac5ec #s-Label_4": {
                      "attributes": {
                        "font-size": "13.0pt",
                        "font-family": "Arial,Arial"
                      }
                    ...
                    "#s-0f48dc8b-de1b-47d3-9fce-7e4484aac5ec #s-Label_4 .valign": {
                      "attributes": {
                        "vertical-align": "middle",
                        "text-align": "center"
                      }
                    ...
                    "#s-0f48dc8b-de1b-47d3-9fce-7e4484aac5ec #s-Label_4 span": {
                      "attributes": {
                        "color": "#6E7270",
                        "text-align": "center",
                        "text-decoration": "none",
  ...
  .on("mouseleave dragleave", ".s-0f48dc8b-de1b-47d3-9fce-7e4484aac5ec .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getDirectEventFirer(this);
  ...
  .on("windowresize", ".s-0f48dc8b-de1b-47d3-9fce-7e4484aac5ec .windowresize", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-0f48dc8b-de1b-47d3-9fce-7e4484aac5ec")) {
      cases = [
        {
          "blocks": [
            {
