jQuery("#simulation")
  .on("click", ".s-f9d36163-48eb-467c-9f12-7cec02735421 .click", function(event, data) {
  ...
  .on("mouseenter dragenter", ".s-f9d36163-48eb-467c-9f12-7cec02735421 .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-f9d36163-48eb-467c-9f12-7cec02735421 #s-Label_2": {
                      "attributes": {
                        "font-size": "13.0pt",
                    ...
                    "#s-f9d36163-48eb-467c-9f12-7cec02735421 #s-Label_2 .valign": {
                      "attributes": {
                    ...
                    "#s-f9d36163-48eb-467c-9f12-7cec02735421 #s-Label_2 span": {
                      "attributes": {
                        "color": "#6E7270",
                        "text-align": "center",
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-f9d36163-48eb-467c-9f12-7cec02735421 #s-Label_3": {
                      "attributes": {
                        "font-size": "13.0pt",
                        "font-family": "Arial,Arial"
                      }
                    ...
                    "#s-f9d36163-48eb-467c-9f12-7cec02735421 #s-Label_3 .valign": {
                      "attributes": {
                        "vertical-align": "middle",
                        "text-align": "center"
                      }
                    ...
                    "#s-f9d36163-48eb-467c-9f12-7cec02735421 #s-Label_3 span": {
                      "attributes": {
                        "color": "#6E7270",
                        "text-align": "center",
                        "text-decoration": "none",
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-f9d36163-48eb-467c-9f12-7cec02735421 #s-Label_4": {
                      "attributes": {
                        "font-size": "13.0pt",
                        "font-family": "Arial,Arial"
                      }
                    ...
                    "#s-f9d36163-48eb-467c-9f12-7cec02735421 #s-Label_4 .valign": {
                      "attributes": {
                        "vertical-align": "middle",
                        "text-align": "center"
                      }
                    ...
                    "#s-f9d36163-48eb-467c-9f12-7cec02735421 #s-Label_4 span": {
                      "attributes": {
                        "color": "#6E7270",
                        "text-align": "center",
                        "text-decoration": "none",
  ...
  .on("mouseleave dragleave", ".s-f9d36163-48eb-467c-9f12-7cec02735421 .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getDirectEventFirer(this);
  ...
  .on("windowresize", ".s-f9d36163-48eb-467c-9f12-7cec02735421 .windowresize", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-f9d36163-48eb-467c-9f12-7cec02735421")) {
      cases = [
        {
          "blocks": [
            {
