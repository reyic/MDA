jQuery("#simulation")
  .on("click", ".s-9c7d3e35-c584-45a1-9a07-e77da1e34dc1 .click", function(event, data) {
  ...
  .on("mouseenter dragenter", ".s-9c7d3e35-c584-45a1-9a07-e77da1e34dc1 .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-9c7d3e35-c584-45a1-9a07-e77da1e34dc1 #s-Label_2": {
                      "attributes": {
                        "font-size": "13.0pt",
                    ...
                    "#s-9c7d3e35-c584-45a1-9a07-e77da1e34dc1 #s-Label_2 .valign": {
                      "attributes": {
                    ...
                    "#s-9c7d3e35-c584-45a1-9a07-e77da1e34dc1 #s-Label_2 span": {
                      "attributes": {
                        "color": "#6E7270",
                        "text-align": "center",
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-9c7d3e35-c584-45a1-9a07-e77da1e34dc1 #s-Label_3": {
                      "attributes": {
                        "font-size": "13.0pt",
                        "font-family": "Arial,Arial"
                      }
                    ...
                    "#s-9c7d3e35-c584-45a1-9a07-e77da1e34dc1 #s-Label_3 .valign": {
                      "attributes": {
                        "vertical-align": "middle",
                        "text-align": "center"
                      }
                    ...
                    "#s-9c7d3e35-c584-45a1-9a07-e77da1e34dc1 #s-Label_3 span": {
                      "attributes": {
                        "color": "#6E7270",
                        "text-align": "center",
                        "text-decoration": "none",
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-9c7d3e35-c584-45a1-9a07-e77da1e34dc1 #s-Label_4": {
                      "attributes": {
                        "font-size": "13.0pt",
                        "font-family": "Arial,Arial"
                      }
                    ...
                    "#s-9c7d3e35-c584-45a1-9a07-e77da1e34dc1 #s-Label_4 .valign": {
                      "attributes": {
                        "vertical-align": "middle",
                        "text-align": "center"
                      }
                    ...
                    "#s-9c7d3e35-c584-45a1-9a07-e77da1e34dc1 #s-Label_4 span": {
                      "attributes": {
                        "color": "#6E7270",
                        "text-align": "center",
                        "text-decoration": "none",
  ...
  .on("mouseleave dragleave", ".s-9c7d3e35-c584-45a1-9a07-e77da1e34dc1 .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getDirectEventFirer(this);
  ...
  .on("windowresize", ".s-9c7d3e35-c584-45a1-9a07-e77da1e34dc1 .windowresize", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-9c7d3e35-c584-45a1-9a07-e77da1e34dc1")) {
      cases = [
        {
          "blocks": [
            {
